 ...
 */
fun myProfile() {
    val namaDepan: String = "Yayang"
    val namaBelakang: String = "Zaelani"
    val umur: Int = 21
    ...
    println("Umur: $umur")
    println("Status: ${if (status) "Pacaran" else "Jomblo"}")
}
 ...
 */
fun myTeam(): List<Any> {
    val teamMembers = listOf("Yayang", "Sabil", "Adi", "Jodhy", "Rina", "Fina")
...
fun main() {
     ...
     *
     */
    groupDetail("Masapuan", listOf("Yayang, Sabil, Adi, Jodhy, Rina, Fina"), "Morning")
